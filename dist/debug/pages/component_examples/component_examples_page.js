...
export function RnUiKitComponentExampleDetailPage({ definition, headerTransparent = false, layoutHost = "default", }) {
    ...
    if (layoutHost === "nativeSheet") {
        return (_jsx(NativeSheetScrollContent, { bindToNativeSheet: isFocused, 
            // @ts-ignore
            iosEmptyViewportScrollEnabled: Platform.OS === "ios" ? true : undefined, nestedScrollEnabled: true, showsVerticalScrollIndicator: true, style: scrollStyle, tracksNavigationBarScrollEdge: Platform.OS === "android" || Platform.OS === "web", children: contents }));
    }
