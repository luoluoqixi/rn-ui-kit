...
export function RnUiKitComponentExamplesDebugPage({ header, onOpenComponentExample, }) {
    ...
    return (_jsxs(View, { style: styles.root, children: [header != null ? (_jsx(View, { style: [
                ...
                ], children: header })) : null, _jsx(NativeList, { backgroundColor: appBackgroundColors.screen, automaticallyAdjustsScrollIndicatorInsets: isNativeIosPage ? true : undefined, contentInsetAdjustmentBehavior: isNativeIosPage ? "automatic" : undefined, contentContainerStyle: horizontalContentInset, tracksNavigationBarScrollEdge: tracksScrollEdgeHeader, children: _jsx(NativeListSection, { children: componentExampleDefinitions.map((definition) => (_jsx(NativeListNavigationItem, { onPress: () => {
