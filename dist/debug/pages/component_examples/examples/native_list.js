...
import { NativeList, NativeListInputItem, NativeListItem, NativeListDropdownItem, NativeListNavigationItem, NativeListSection, NativeListSelectItem, NativeListSwitchItem, NativeListTextAreaItem, Select, Switch, Text, isIos15, useUiTheme, isIos, isAndroid, } from "rn-ui-kit/core";
...
export function NativeListExample() {
    ...
    return (_jsxs(View, { style: styles.exampleRoot, children: [_jsxs(View, { style: styles.exampleHeader, children: [isIos() && (_jsx(Switch, { checked: native, label: "\u4F7F\u7528\u539F\u751F List \u5916\u89C2", labelPosition: "right", onCheckedChange: (nextNative) => {
                            ...
                            if (!nextEditMode) {
                                ...
                                }, options: NATIVE_LIST_BASIC_STYLE_OPTIONS, value: basicListStyle })] })) : null] }), _jsx(View, { style: styles.nativeListFrame, children: native || fallbackMounted ? (_jsxs(NativeList, { nativeHaptics: true, dismissKeyboardOnTap: true, contextMenuProps: {
                        items: [
                            {
                                label: "复制标题",
                        ...
                        setLastAction("下拉刷新完成");
                                ...
                                items: [
                            ...
                            }, footer: "\u5BFC\u822A\u884C\u9002\u5408\u8DF3\u8F6C\u5230\u66F4\u6DF1\u5C42\u7684\u8BBE\u7F6E\u9875\u3002", title: "\u5DE5\u4F5C\u533A", titleColor: "#7c3aed", trailing: renderNativeListSortTrailing, children: [_jsx(NativeListNavigationItem, { chevronColor: NATIVE_LIST_ICON_COLOR, contextMenuProps: {
                                        items: [
                                            {
                                                label: "详情专属菜单",
                                    ...
                                    value: workspaceNote,
                                        ...
                                        placeholder: "Item",
                                        value: "item",
                                    }, title: "\u4EC5\u4E00\u4E2AItem" })] })] }, native ? `native-list-${iosListStyle}` : "fallback-list")) : null }), _jsxs(Text, { variant: "small", numberOfLines: 2, style: { opacity: 0.6, textAlign: "center" }, children: ["\u7F16\u8F91\u6A21\u5F0F\uFF1A", editMode ? `已选 ${selectedIds.length} 项` : "关闭", " \u00B7 \u6700\u8FD1\u52A8\u4F5C\uFF1A", lastAction] })] }));
}
