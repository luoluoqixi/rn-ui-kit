...
import { Bold, ChevronLeft, FolderPlus, Italic, Link, ListMusic, List, MoreHorizontal, Music2, Pause, Play, Plus, } from "@tamagui/lucide-icons-2";
import { useState } from "react";
import { Platform, Pressable, StyleSheet, View, useColorScheme, } from "react-native";
import { useSafeAreaInsets } from "react-native-safe-area-context";
import { Button, GlassEffect, GlassEffectSearchBar, NativeList, NativeListInputItem, NativeListItem, NativeListSection, NativeListSelectItem, NativeListSwitchItem, Text, isGlassEffectAPIAvailable, isLiquidGlassAvailable, useAppBackgroundColors, isIos26Plus, } from "rn-ui-kit/core";
const MODE_OPTIONS = [
...
function GlassEffectPreview({ animateStyleChanges, animationDuration, bottomOffset, buttonCount, colorScheme, compact, containerSpacing, cornerRadius, effectStyle, editorFocused, onEditorFocusedChange, fallbackSurfaceColor, glassAvailable, horizontalInset, interactive, mode, onAction, onLayoutSizeChange, onPlayingChange, onSearchChange, playing, search, showSubtitle, tintColor, }) {
    ...
    if (mode === "search") {
        return (_jsx(GlassEffectSearchBar, { ...sharedGlassProps, accessibilityLabel: "\u60AC\u6D6E\u641C\u7D22\u5DE5\u5177\u680F", inputColor: foregroundColor, inputProps: {
                ...
                value: search,
            }, onCancel: () => onAction("取消搜索"), onLayout: handleLayout, placeholder: "\u641C\u7D22\u7EC4\u4EF6\u6216\u8BBE\u7F6E", placeholderTextColor: secondaryColor, searchIconColor: secondaryColor, searchStyle: [{ borderRadius: cornerRadius }, fallbackStyle], unfocusedTrailing: _jsx(Button, { "aria-label": "\u65B0\u5EFA\u5185\u5BB9", native: isIos26Plus() ? "swift-ui" : false, circular: true, nativeButtonStyle: "glass", buttonSize: {
    ...
    if (mode === "editor") {
        ...
        return (_jsxs(GlassEffect, { ...sharedGlassProps, accessibilityLabel: "\u8DDF\u968F\u952E\u76D8\u7684\u7F16\u8F91\u5DE5\u5177\u680F", keyboardAvoidance: usesNativeEditorToolbar ? true : { subtractSafeAreaInset: false }, keyboardHiddenConfirmation: { finalHeight: -64 }, onLayout: handleLayout, onKeyboardHidden: () => onEditorFocusedChange(false), style: [
                ...
                fallbackStyle,
            ], testID: "glass-effect-editor-toolbar", children: [_jsx(Button, { "aria-label": "\u52A0\u7C97", buttonSize: { height: 48, width: 48 }, circular: true, native: usesNativeEditorToolbar ? "swift-ui" : false, nativeButtonStyle: "glass", nativeSystemImage: "bold", onPress: () => onAction("切换加粗"), title: "\u52A0\u7C97", children: _jsx(Bold, { color: foregroundColor, size: 21 }) }), _jsx(Button, { "aria-label": "\u659C\u4F53", buttonSize: { height: 48, width: 48 }, circular: true, native: usesNativeEditorToolbar ? "swift-ui" : false, nativeButtonStyle: "glass", nativeSystemImage: "italic", onPress: () => onAction("切换斜体"), title: "\u659C\u4F53", children: _jsx(Italic, { color: foregroundColor, size: 21 }) }), _jsx(Button, { "aria-label": "\u63D2\u5165\u5217\u8868", buttonSize: { height: 48, width: 48 }, circular: true, native: usesNativeEditorToolbar ? "swift-ui" : false, nativeButtonStyle: "glass", nativeSystemImage: "list.bullet", onPress: () => onAction("插入列表"), title: "\u5217\u8868", children: _jsx(List, { color: foregroundColor, size: 21 }) }), _jsx(View, { style: styles.flexSpacer }), _jsx(Button, { "aria-label": "\u63D2\u5165\u94FE\u63A5", buttonSize: { height: 48, width: 48 }, circular: true, native: usesNativeEditorToolbar ? "swift-ui" : false, nativeButtonStyle: "glass", nativeSystemImage: "link", onPress: () => onAction("插入链接"), title: "\u94FE\u63A5", children: _jsx(Link, { color: foregroundColor, size: 21 }) })] }));
    }
    if (mode === "music") {
...
export function GlassEffectExample() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(NativeList, { automaticallyAdjustsScrollIndicatorInsets: Platform.OS === "ios" ? true : undefined, backgroundColor: appBackgroundColors.screen, contentInsetAdjustmentBehavior: Platform.OS === "ios" ? "automatic" : undefined, contentMarginBottom: 190, iosListStyle: "insetGrouped", style: styles.list, tracksNavigationBarScrollEdge: true, children: [_jsxs(NativeListSection, { footer: "\u5DE5\u5177\u680F\u4E0E\u5BFC\u822A\u65E0\u5173\uFF0C\u53EA\u662F\u53E0\u653E\u5728\u9875\u9762\u6839\u8282\u70B9\u4E0A\uFF1B\u5207\u6362\u6A21\u5F0F\u4E0D\u4F1A\u6539\u53D8 NativeList \u7684\u6EDA\u52A8\u5BB9\u5668\u3002", title: "\u9884\u89C8\u6A21\u5F0F", children: [_jsx(NativeListSelectItem, { selectProps: {
                                    ...
                                    value: mode,
                                }, title: "\u5DE5\u5177\u680F\u5C55\u793A\u6A21\u5F0F" }), _jsx(NativeListItem, { chevron: false, subtitle: `当前平台：${Platform.OS}`, title: "Liquid Glass \u53EF\u7528", value: glassAvailable ? "是" : "否，普通 View 降级" }), _jsx(NativeListItem, { chevron: false, title: "\u539F\u751F Glass API \u53EF\u7528", value: glassApiAvailable ? "是" : "否" }), _jsx(NativeListItem, { chevron: false, title: "\u6700\u8FD1\u4E00\u6B21\u5E03\u5C40", value: lastLayoutSize }), _jsx(NativeListItem, { chevron: false, title: "\u6700\u8FD1\u64CD\u4F5C", value: lastAction })] }), mode === "editor" ? (_jsx(NativeListSection, { footer: "\u70B9\u51FB\u8F93\u5165\u6846\u540E\uFF0C\u5DE5\u5177\u680F\u4F1A\u663E\u793A\u5728\u952E\u76D8\u4E0A\u65B9\uFF1B\u70B9\u51FB\u683C\u5F0F\u6309\u94AE\u4E0D\u4F1A\u6536\u8D77\u952E\u76D8\u3002", title: "\u7F16\u8F91\u5668\u8F93\u5165", children: _jsx(NativeListInputItem, { inputProps: {
