...
function GlassEffectPreview({ animateStyleChanges, animationDuration, bottomOffset, buttonCount, colorScheme, compact, containerSpacing, cornerRadius, effectStyle, editorKeyboardVisible, fallbackSurfaceColor, glassAvailable, horizontalInset, interactive, mode, onAction, onLayoutSizeChange, onPlayingChange, onSearchChange, playing, search, showSubtitle, tintColor, }) {
    ...
    if (mode === "editor") {
        ...
        return (_jsxs(GlassEffect, { ...sharedGlassProps, accessibilityLabel: "\u8DDF\u968F\u952E\u76D8\u7684\u7F16\u8F91\u5DE5\u5177\u680F", keyboardAvoidance: usesNativeEditorToolbar ? true : { subtractSafeAreaInset: false }, keyboardHiddenConfirmation: { finalHeight: -64 }, onLayout: handleLayout, style: [
                ...
                fallbackStyle,
            ], testID: "glass-effect-editor-toolbar", children: [_jsx(Button, { "aria-label": "\u52A0\u7C97", variant: "secondary", buttonSize: { height: 48, width: 60 }, native: usesNativeEditorToolbar, nativeButtonStyle: "glass", nativeSystemImage: "bold", onPress: () => onAction("切换加粗"), title: "\u52A0\u7C97", children: _jsx(Bold, { color: foregroundColor, size: 21 }) }), _jsx(Button, { "aria-label": "\u659C\u4F53", variant: "secondary", buttonSize: { height: 48, width: 60 }, native: usesNativeEditorToolbar, nativeButtonStyle: "glass", nativeSystemImage: "italic", onPress: () => onAction("切换斜体"), title: "\u659C\u4F53", children: _jsx(Italic, { color: foregroundColor, size: 21 }) }), _jsx(Button, { variant: "secondary", "aria-label": "\u63D2\u5165\u5217\u8868", buttonSize: { height: 48, width: 60 }, native: usesNativeEditorToolbar, nativeButtonStyle: "glass", nativeSystemImage: "list.bullet", onPress: () => onAction("插入列表"), title: "\u5217\u8868", children: _jsx(List, { color: foregroundColor, size: 21 }) }), _jsx(View, { style: styles.flexSpacer }), _jsx(Button, { variant: "secondary", "aria-label": "\u63D2\u5165\u94FE\u63A5", buttonSize: { height: 48, width: 60 }, native: usesNativeEditorToolbar, nativeButtonStyle: "glass", nativeSystemImage: "link", onPress: () => onAction("插入链接"), title: "\u94FE\u63A5", children: _jsx(Link, { color: foregroundColor, size: 21 }) })] }));
    }
    if (mode === "music") {
