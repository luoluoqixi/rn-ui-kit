...
import { FlashList, ListGroup, ListItem, NativeList, NativeListInputItem, NativeListItem, NativeListMenuItem, NativeListNavigationItem, NativeListSection, NativeListSelectItem, NativeListSwitchItem, NativeListTextAreaItem, ScrollView, Select, Switch, Text, isIos15, os, } from "rn-ui-kit/core";
...
function NativeListExample() {
    ...
    return (_jsx(ExampleStack, { children: _jsxs(ExampleBlock, { description: "\u5B8C\u6574\u8986\u76D6\u4E0B\u62C9\u5237\u65B0\u3001\u5BFC\u822A\u3001\u5F00\u5173\u3001\u5355\u9009\u3001Select \u4E0E\u5E73\u53F0\u539F\u751F picker \u53D8\u4F53\u3002", title: "\u5DE5\u4F5C\u533A\u8BBE\u7F6E", children: [_jsx(Switch, { checked: native, label: "\u4F7F\u7528\u539F\u751F List \u5916\u89C2", labelPosition: "end", onCheckedChange: (nextNative) => {
                        setFallbackMounted(false);
                        setNative(nextNative);
                    } }), _jsx(Switch, { checked: editMode, label: `备忘录式编辑模式（已选 ${selectedIds.length} 项）`, labelPosition: "end", onCheckedChange: (nextEditMode) => {
                        setEditMode(nextEditMode);
                        if (!nextEditMode) {
                            setSelectedIds([]);
                        }
                    } }), os() === "ios" && (_jsx(Switch, { checked: iosCustomEditMode, disabled: os() !== "ios", label: "iOS \u4F7F\u7528\u81EA\u5B9A\u4E49\u7F16\u8F91\u6A21\u5F0F", labelPosition: "end", onCheckedChange: setIosCustomEditMode })), _jsx(Switch, { checked: customEditModeIcon, disabled: os() === "ios" && !iosCustomEditMode, label: "\u81EA\u5B9A\u4E49\u7F16\u8F91\u6A21\u5F0F\u56FE\u6807", labelPosition: "end", onCheckedChange: setCustomEditModeIcon }), _jsx(View, { style: styles.nativeListFrame, children: native || fallbackMounted ? (_jsxs(NativeList, { contextMenuProps: {
                            items: [
                                {
                                    label: "复制标题",
                        ...
                        }, editMode: editMode, editModeIcon: customEditModeIcon ? _jsx(Square, { color: "$color10", size: 24 }) : undefined, editModeSelectedIcon: customEditModeIcon ? _jsx(SquareCheckBig, { color: "$color10", size: 24 }) : undefined, fixesIOS26NestedScrollIndicatorSafeArea: true, iosEditModeVariant: iosCustomEditMode ? "custom" : "native", native: native, nestedScrollEnabled: true, onSelectedIdsChange: setSelectedIds, onRefresh: async () => {
                            ...
                            setLastAction("下拉刷新完成");
                                    ...
                                    items: [
                                ...
                                }, footer: "\u5BFC\u822A\u884C\u9002\u5408\u8DF3\u8F6C\u5230\u66F4\u6DF1\u5C42\u7684\u8BBE\u7F6E\u9875\u3002", title: "\u5DE5\u4F5C\u533A", titleColor: "#7c3aed", trailing: _jsx(Select, { value: "defaultSort", renderValue: () => "排序方式", options: NATIVE_LIST_SORT_LIST, nativeTrigger: true, nativeTriggerLabelProps: {
                                        fontSize: 14,
                                        color: "$accent11",
                                        opacity: 1,
                                        ...
                                        minHeight: 32,
                                        minWidth: 0,
                                    } }), children: [_jsx(NativeListNavigationItem, { chevronColor: NATIVE_LIST_ICON_COLOR, contextMenuProps: {
                                            items: [
                                                {
                                                    label: "详情专属菜单",
                                        ...
                                        value: workspaceNote,
                                            ...
                                            placeholder: "选择主题模式",
                                            value: theme ?? undefined,
                                        }, title: "Android Dialog" })) : null] })] }, native ? "native-list" : "fallback-list")) : null }), _jsxs(Text, { opacity: 0.6, children: ["\u7F16\u8F91\u6A21\u5F0F\uFF1A", editMode ? `已选 ${selectedIds.length} 项` : "关闭", " \u00B7 iOS \u5B9E\u73B0\uFF1A", iosCustomEditMode ? "自定义" : "原生", " \u00B7 \u7F16\u8F91\u56FE\u6807\uFF1A", customEditModeIcon ? "自定义" : "默认", " \u00B7 \u6700\u8FD1\u52A8\u4F5C\uFF1A", lastAction, " \u00B7 \u81EA\u52A8\u540C\u6B65\uFF1A", autoSyncEnabled ? "开启" : "关闭", " \u00B7 \u4E3B\u9898\uFF1A", theme ?? "未选择", " \u00B7 \u9891\u7387\uFF1A", syncInterval ?? "未选择", " \u00B7 \u5907\u4EFD\uFF1A", backupInterval, " \u00B7 \u540D\u79F0\uFF1A", workspaceName || "未填写", " \u00B7 \u5907\u6CE8\uFF1A", workspaceNote || "未填写"] })] }) }));
}
