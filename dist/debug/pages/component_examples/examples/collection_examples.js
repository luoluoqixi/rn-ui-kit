...
import { CalendarDays, CircleOff, Clock, Clock4, Info, ListFilter, Palette, RefreshCw, SlidersHorizontal, Smartphone, Timer, Users, } from "@tamagui/lucide-icons-2";
...
function NativeListExample() {
    ...
    return (_jsx(ExampleStack, { children: _jsxs(ExampleBlock, { description: "\u5B8C\u6574\u8986\u76D6\u4E0B\u62C9\u5237\u65B0\u3001\u5BFC\u822A\u3001\u5F00\u5173\u3001\u5355\u9009\u3001Select \u4E0E\u5E73\u53F0\u539F\u751F picker \u53D8\u4F53\u3002", title: "\u5DE5\u4F5C\u533A\u8BBE\u7F6E", children: [_jsx(Switch, { checked: native, label: "\u4F7F\u7528\u539F\u751F List \u5916\u89C2", labelPosition: "end", onCheckedChange: (nextNative) => {
                    ...
                    } }), _jsx(View, { style: styles.nativeListFrame, children: native || fallbackMounted ? (_jsxs(NativeList, { fixesIOS26NestedScrollIndicatorSafeArea: true, native: native, nestedScrollEnabled: true, onRefresh: async () => {
                            await new Promise((resolve) => {
                                setTimeout(resolve, 1200);
                            });
                            setLastAction("下拉刷新完成");
                        }, children: [_jsxs(NativeListSection, { footer: "\u5BFC\u822A\u884C\u9002\u5408\u8DF3\u8F6C\u5230\u66F4\u6DF1\u5C42\u7684\u8BBE\u7F6E\u9875\u3002", title: "\u5DE5\u4F5C\u533A", titleColor: "#7c3aed", children: [_jsx(NativeListNavigationItem, { chevronColor: NATIVE_LIST_ICON_COLOR, icon: _jsx(Info, { color: NATIVE_LIST_ICON_COLOR, size: NATIVE_LIST_ICON_SIZE }), sfSymbol: "info.circle", onPress: () => setLastAction("打开详情"), subtitle: "\u5E26\u6709 chevron \u7684\u5BFC\u822A\u884C", subtitleColor: "#64748b", subtitleFontSize: 12, title: "\u8BE6\u60C5", titleColor: "#7c3aed", titleFontSize: 18 }), _jsx(NativeListNavigationItem, { icon: _jsx(Users, { color: NATIVE_LIST_ICON_COLOR, size: NATIVE_LIST_ICON_SIZE }), sfSymbol: "person.2", onPress: () => setLastAction("打开成员管理"), subtitle: "\u9080\u8BF7\u3001\u89D2\u8272\u4E0E\u8BBF\u95EE\u6743\u9650", title: "\u6210\u5458" })] }), _jsxs(NativeListSection, { footer: "Switch \u9002\u5408\u5373\u65F6\u751F\u6548\u7684\u72EC\u7ACB\u504F\u597D\u3002", title: "\u540C\u6B65", children: [_jsx(NativeListSwitchItem, { icon: _jsx(RefreshCw, { color: NATIVE_LIST_ICON_COLOR, size: NATIVE_LIST_ICON_SIZE }), sfSymbol: "arrow.clockwise", switchProps: { checked: autoSyncEnabled, onCheckedChange: setAutoSyncEnabled }, title: "\u81EA\u52A8\u540C\u6B65" }), _jsx(NativeListSelectItem, { icon: _jsx(Palette, { color: NATIVE_LIST_ICON_COLOR, size: NATIVE_LIST_ICON_SIZE }), sfSymbol: "paintpalette", selectProps: {
