...
export function DropdownExample() {
    ...
    return (_jsxs(ExampleStack, { children: [_jsxs(ExampleBlock, { title: "\u9879\u76EE\u83DC\u5355", children: [_jsx(DropdownPair, { native: false, items: items, triggerLabel: "\u6253\u5F00 Dropdown" }), _jsxs(Text, { variant: "muted", children: ["\u6700\u8FD1\u52A8\u4F5C\uFF1A", action] })] }), !isWeb() && (_jsxs(ExampleBlock, { title: "\u539F\u751F\u9879\u76EE\u83DC\u5355", children: [_jsx(DropdownPair, { native: true, items: items, triggerLabel: "Native Dropdown" }), _jsxs(Text, { variant: "muted", children: ["\u6700\u8FD1\u52A8\u4F5C\uFF1A", action] })] })), _jsxs(ExampleBlock, { title: "\u7981\u7528", children: [_jsx(DropdownPair, { disabled: true, native: false, items: items, triggerLabel: "\u6253\u5F00 Dropdown" }), _jsx(DropdownPair, { disabled: true, native: true, items: items, triggerLabel: "\u6253\u5F00 Dropdown" })] })] }));
}
