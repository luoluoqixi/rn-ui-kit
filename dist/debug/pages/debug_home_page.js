...
import { NativeList, NativeListButtonItem, NativeListCustomItem, NativeListNavigationItem, NativeListSection, NativeListSwitchItem, Slider, useAppBackgroundColors, } from "../../core/components/ui";
export function RnUiKitDebugHomePage({ openSectionsInSheet, onRefresh, pages, onOpenPanelSheet, sectionSheetPosition, onOpenSection, onSectionSheetPositionChange, onOpenSectionsInSheetChange, }) {
    ...
    return (_jsxs(NativeList, { backgroundColor: appBackgroundColors.screen, onRefresh: onRefresh, automaticallyAdjustsScrollIndicatorInsets: isNativeIosPage ? true : undefined, contentInsetAdjustmentBehavior: isNativeIosPage ? "automatic" : undefined, contentContainerStyle: horizontalContentInset, tracksNavigationBarScrollEdge: tracksScrollEdgeHeader, children: [sections.map(([section, sectionPages]) => (_jsx(NativeListSection, { title: section, children: [...sectionPages]
