...
import { NativeList, NativeListButtonItem, NativeListCustomItem, NativeListNavigationItem, NativeListSection, NativeListSwitchItem, Slider, } from "rn-ui-kit/core";
export function RnUiKitDebugHomePage({ layoutHost = "default", openSectionsInSheet, onRefresh, pages, onOpenPanelSheet, sectionSheetPosition, onOpenSection, onSectionSheetPositionChange, onOpenSectionsInSheetChange, }) {
    ...
    return (_jsxs(NativeList, { onRefresh: onRefresh, automaticallyAdjustsScrollIndicatorInsets: isNativeIosPage ? true : undefined, contentInsetAdjustmentBehavior: usesNativeIosScrollEdgeHeader ? "automatic" : undefined, tracksNavigationBarScrollEdge: tracksScrollEdgeHeader, children: [sections.map(([section, sectionPages]) => (_jsx(NativeListSection, { title: section, children: [...sectionPages]
