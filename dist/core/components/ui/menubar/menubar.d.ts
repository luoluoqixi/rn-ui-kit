...
declare function MenubarRoot({ children, className, items, nativeHaptics, itemNativeHaptics, value: valueProp, onValueChange: onValueChangeProp, ...props }: MenubarProps): React.JSX.Element;
declare function MenubarTrigger({ className, nativeHaptics, onPress, ...props }: React.ComponentProps<typeof MenubarPrimitive.Trigger> & {
...
declare function MenubarSubContent({ className, children, ...props }: React.ComponentProps<typeof MenubarPrimitive.SubContent>): React.JSX.Element;
declare function MenubarContent({ className, children, overlayClassName, overlayStyle, portalHost, align, alignOffset, sideOffset, style, ...props }: React.ComponentProps<typeof MenubarPrimitive.Content> & {
