...
export const NativeTriggerFace = React.forwardRef(function NativeTriggerFace({ content, containerStyle, icon = "chevrons-up-down", iconColor: iconColorProp, labelProps, label, opacity = 1, }, forwardedRef) {
    ...
    return (_jsx(View, { ref: forwardedRef, pointerEvents: "none", style: { alignSelf: "center", flexGrow: 0, flexShrink: 0, opacity, width: "auto" }, children: _jsxs(View, { style: [styles.defaultTrigger, containerStyle], children: [renderTriggerLabel(label, labelProps), _jsx(View, { style: { opacity: iconOpacity }, children: renderTriggerIcon(icon, iconColor) })] }) }));
});
export const NativeTrigger = React.forwardRef(({ active = false, content, containerStyle, disabled, feedbackOpacity, icon, iconColor, keepPressedOpacity = false, labelProps, label, onPressIn, onLongPress, onPressOut, pressedOpacity = true, style, className, onHoverIn, onHoverOut, ...pressableProps }, forwardedRef) => {
    ...
    return (_jsx(Pressable, { ref: forwardedRef, ...resolvedPressableProps, className: cn(Platform.OS === "web" && "cursor-default", className), disabled: disabled, onHoverIn: (event) => {
        ...
        ], children: _jsx(NativeTriggerFace, { content: content, containerStyle: containerStyle, icon: icon, iconColor: iconColor, label: label, labelProps: labelProps }) }));
});
/** `NativeTrigger` 的兼容别名。 */
