...
export const NativeTrigger = React.forwardRef(({ active = false, content, containerStyle, disabled, icon, keepPressedOpacity = false, labelProps, label, onPressIn, onPressOut, pressedOpacity = true, style, ...pressableProps }, forwardedRef) => {
    ...
    return (_jsx(Pressable, { ref: forwardedRef, ...pressableProps, disabled: disabled, onPressIn: (event) => {
