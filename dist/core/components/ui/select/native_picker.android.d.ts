...
export declare function NativePickerDialog({ anchorAlign, anchorWidth, anchorEdgeOffset, anchorVerticalAlign, anchorStrategy, visible, value, items, mode, onValueChange, onBlur, }: {
...
export declare const NativePickerSwiftUI: React.ForwardRefExoticComponent<{
    ...
    nativeTriggerPressableProps?: Pick<PressableProps, "disabled" | "onLongPress" | "onPress" | "onPressIn" | "onPressOut" | "onTouchCancel" | "onTouchEnd">;
