...
export const SelectDropdown = React.forwardRef(function SelectDropdown(props, ref) {
    ...
    return (_jsx(Dropdown, { disabled: props.disabled ?? props.isDisabled, ...(!useNativeTrigger ? { __nativeDetachedAnchor: true } : {}), __menuRef: menuRef, native: isNative, items: items, itemProps: props.itemProps, nativeAnchorAlignment: nativeDropdownAlign, nativeHaptics: props.nativeHaptics, 
        ...
        nativeTrigger: useNativeTrigger, nativeTriggerContainerStyle: props.nativeTriggerContainerStyle, nativeTriggerContent: props.nativeTriggerContent, nativeTriggerIcon: props.nativeTriggerIcon, nativeTriggerLabelProps: props.nativeTriggerLabelProps, nativeTriggerProps: props.nativeTriggerProps, nativeTriggerFeedbackOpacity: props.nativeTriggerFeedbackOpacity, nativeTriggerHoverBackground: props.nativeTriggerHoverBackground, nativeSelectedItemBackgroundColor: theme.accent, onOpenChange: props.onOpenChange, onOpenWillChange: props.onOpenWillChange, triggerClassName: props.className, triggerProps: {
            ...props.triggerProps,
