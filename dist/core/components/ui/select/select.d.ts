...
declare const SelectComponent: React.ForwardRefExoticComponent<SelectProps & React.RefAttributes<SelectHandle>> & {
    Content: ({ className, children, position, align, side: sideProp, showScrollButtons, initialScrollOffset, portalHost, viewportProps, ...props }: import("./types").SelectContentProps) => React.JSX.Element;
    ...
    Trigger: ({ className, children, size, ...props }: import("./types").SelectTriggerProps) => React.JSX.Element;
