...
function TrueSheetStackNavigationInner({ children, initialRouteName, navigationRef, screenOptions, }) {
    ...
    return (_jsx(NavigationIndependentTree, { children: _jsx(NavigationContainer, { ref: ref, theme: navigationTheme, children: _jsx(View, { style: styles.stackRoot, children: _jsx(JsStack.Navigator
                ...
                , { 
                    ...
                    // absoluteFill style，导致当前卡片高度为 0；原生 Android 仍需
                    // 保持 false，避免 TrueSheet 内嵌 Stack 的 screens 容器干预布局。
                    detachInactiveScreens: Platform.OS === "web" ? true : false, initialRouteName: initialRouteName, screenOptions: screenOptions, children: children }) }) }) }));
}
/**
