...
function NativeSheetStackRoot({ children, initialRouteName = "index", name, onOpenChange, open = false, overlayPortalHostName, headerLeft, headerLeftButtonProps, headerLeftItems, headerRight, headerRightButtonProps, headerRightButtonVisible, headerRightItems, screenOptions, sheetProps, }) {
    ...
    if (sheetProps == null) {
        return (_jsx(TrueSheetStackHost, { initialRouteName: initialRouteName, name: sheetName, onRequestClose: () => onOpenChange?.(false), onDidDismiss: () => onOpenChange?.(false), overlayPortalHostName: overlayPortalHostName, headerLeft: headerLeft, headerLeftButtonProps: headerLeftButtonProps, headerLeftItems: headerLeftItems, headerRight: headerRight, headerRightButtonProps: headerRightButtonProps, headerRightButtonVisible: headerRightButtonVisible, headerRightItems: headerRightItems, screenOptions: screenOptions, sheetProps: {
