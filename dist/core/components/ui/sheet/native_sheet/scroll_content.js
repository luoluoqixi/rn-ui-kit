 ...
 */
export const NativeSheetScrollContent = forwardRef(({ bindToNativeSheet = false, children, contentContainerStyle, extraBottomPadding, navigationBarScrollEdgeOptions, onScroll, scrollEventThrottle, style, tracksNavigationBarScrollEdge, ...rest }, ref) => {
    ...
    return (_jsx(ScrollView, { ref: setScrollViewRef, keyboardShouldPersistTaps: "handled", nestedScrollEnabled: true, onScroll: trackedOnScroll, showsVerticalScrollIndicator: true, style: [styles.iosScroll, style], contentContainerStyle: [
            styles.iosContent,
            { paddingBottom: bottomPadding },
            contentContainerStyle,
        ], scrollIndicatorInsets: {
            bottom: indicatorBottomInset,
        }, scrollEventThrottle: scrollEventThrottle ?? (trackedOnScroll == null ? undefined : 16), contentInsetAdjustmentBehavior: automaticContentInsetAdjustment ? "automatic" : "never", ...rest, children: children }));
});
