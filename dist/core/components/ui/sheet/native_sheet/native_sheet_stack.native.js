...
function TrueSheetNativeSheetStackRoot({ children, initialRouteName = "index", name, onOpenChange, open = false, overlayPortalHostName, headerLeft, headerLeftButtonProps, headerLeftItems, headerRight, headerRightButtonProps, headerRightButtonVisible, headerRightItems, screenOptions, sheetProps, }) {
    ...
    return (_jsx(TrueSheetStackHost, { initialRouteName: initialRouteName, name: sheetName, navigationRef: navigationRef, onDidDismiss: () => {
            ...
            onOpenChange?.(false);
        }, overlayPortalHostName: resolvedOverlayPortalHostName, headerLeft: headerLeft, headerLeftButtonProps: headerLeftButtonProps, headerLeftItems: headerLeftItems, headerRight: headerRight, headerRightButtonProps: headerRightButtonProps, headerRightButtonVisible: headerRightButtonVisible, headerRightItems: headerRightItems, screenOptions: screenOptions, sheetProps: resolvedSheetProps, children: children }));
}
