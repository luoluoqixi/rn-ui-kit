...
function TrueSheetNativeSheetStackRoot({ children, initialRouteName = "index", name, onOpenChange, open = false, overlayPortalHostName, headerLeft, headerRightButtonProps, screenOptions, sheetProps, }) {
    ...
    return (_jsx(TrueSheetStackHost, { initialRouteName: initialRouteName, name: sheetName, navigationRef: navigationRef, onDidDismiss: () => {
            ...
            onOpenChange?.(false);
        }, overlayPortalHostName: resolvedOverlayPortalHostName, headerLeft: headerLeft, headerRightButtonProps: headerRightButtonProps, screenOptions: screenOptions, sheetProps: resolvedSheetProps, children: children }));
}
