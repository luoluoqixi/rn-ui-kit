...
export type ContextMenuSubContentProps = Omit<ComponentProps<typeof ContextMenuPrimitive.SubContent>, "children"> & {
    children?: ReactNode;
...
export type ContextMenuItemImageProps = {
    children?: ReactNode;
};
...
export type ContextMenuProps = ComponentProps<typeof ContextMenuPrimitive.Root> & ContextMenuRootExtensions;
export type ContextMenuRootExtensions = {
    ...
    triggerProps?: Omit<ComponentProps<typeof ContextMenuPrimitive.Trigger>, "children"> & Record<string, unknown>;
};
