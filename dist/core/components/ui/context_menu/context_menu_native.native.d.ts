...
declare function ContextMenu({ children, items, itemProps, itemNativeHaptics, itemNativeHapticsDelay, nativeHaptics, nativeHapticsDelay, onOpenChange, onOpenWillChange, trigger, triggerProps, nativeShouldWaitForMenuToHideBeforeFiringOnPressMenuItem, __menuRef, __unsafeIosProps, ...props }: ContextMenuProps): React.JSX.Element;
