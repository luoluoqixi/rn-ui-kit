...
function ContextMenuContent({ className, overlayClassName, overlayStyle, portalHost, style, itemNativeHaptics, size: sizeProp, side: sideProp, children, ...props }) {
...
function ContextMenu({ children, items, itemProps, itemNativeHaptics, contentSize, native = Platform.OS !== "web", nativeHaptics, nativeShouldWaitForMenuToHideBeforeFiringOnPressMenuItem, __menuRef, __unsafeIosProps, onOpenChange, onOpenWillChange, trigger, triggerProps, ...props }) {
    ...
    return (_jsx(ContextMenuHapticsContext.Provider, { value: { item: resolvedItemHaptics }, children: _jsx(ContextMenuContentSizeContext.Provider, { value: contentSize ?? "default", children: _jsx(ContextMenuPrimitiveRoot, { ...props, onOpenChange: (open) => {
