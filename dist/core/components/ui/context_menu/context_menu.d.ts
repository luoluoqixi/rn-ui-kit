...
declare function ContextMenuSubTrigger({ className, inset, children, iconClassName, nativeHaptics, nativeHapticsDelay, onPress, ...props }: ContextMenuSubTriggerProps): React.JSX.Element;
declare function ContextMenuSubContent({ className, style, size: sizeProp, children, ...props }: ContextMenuSubContentProps): React.JSX.Element;
declare function ContextMenuContent({ className, overlayClassName, overlayStyle, portalHost, style, itemNativeHaptics, itemNativeHapticsDelay, size: sizeProp, side: sideProp, children, ...props }: ContextMenuContentProps): React.JSX.Element;
declare function ContextMenuItem({ className, disabled, inset, nativeHaptics, nativeHapticsDelay, onPress, variant, ...props }: ContextMenuItemComponentProps): React.JSX.Element;
declare function ContextMenuCheckboxItem({ className, children, disabled, nativeHaptics, nativeHapticsDelay, onCheckedChange, ...props }: ContextMenuCheckboxItemProps): React.JSX.Element;
...
declare function ContextMenu({ children, items, itemProps, itemNativeHaptics, itemNativeHapticsDelay, contentSize, native, nativeHaptics, nativeHapticsDelay, nativeShouldWaitForMenuToHideBeforeFiringOnPressMenuItem, __menuRef, __unsafeIosProps, onOpenChange, onOpenWillChange, trigger, triggerProps, ...props }: ContextMenuProps): React.JSX.Element;
