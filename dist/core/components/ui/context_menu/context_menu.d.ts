...
declare function ContextMenuContent({ className, overlayClassName, overlayStyle, portalHost, style, itemNativeHaptics, size: sizeProp, side: sideProp, children, ...props }: ContextMenuContentProps): React.JSX.Element;
...
declare function ContextMenu({ children, items, itemProps, itemNativeHaptics, contentSize, native, nativeHaptics, nativeShouldWaitForMenuToHideBeforeFiringOnPressMenuItem, __menuRef, __unsafeIosProps, onOpenChange, onOpenWillChange, trigger, triggerProps, ...props }: ContextMenuProps): React.JSX.Element;
