...
export declare function resolveSliderValues(value: SliderValue | undefined): number[] | undefined;
export declare function resolveSliderFirstValue(value: SliderValue | undefined, fallback: number): number;
