...
export function NativeListDropdownItem(props) {
    ...
    return (_jsx(NativeListRow, { ...itemProps, cursorDefault: true, disabled: disabled, labelOpacity: props.fadeTitleOnOpen !== false && menuOpen ? NATIVE_LIST_ITEM_OPEN_OPACITY : 1, nativeHaptics: false, onPress: () => {
            ...
            presentMenuFromRow();
        }, pressedOpacity: NATIVE_LIST_ITEM_PRESS_OPACITY, suppressPressBackground: true, value: undefined, trailing: _jsx(View, { collapsable: false, onTouchCancel: Platform.OS === "ios" ? cancelTriggerInteraction : undefined, onTouchEnd: Platform.OS === "ios" ? finishTriggerInteraction : undefined, onTouchStart: Platform.OS === "ios" ? beginTriggerInteraction : undefined, style: { alignItems: "center", alignSelf: "stretch", justifyContent: "center" }, children: _jsx(Dropdown, { ...dropdownProps, __menuRef: menuRef, ...(dropdownProps.open === undefined ? {} : { open: dropdownProps.open }), nativeHaptics: inheritedHaptics, nativeTrigger: true, nativeTriggerIcon: "chevrons-up-down", nativeTriggerLabelProps: nativeTriggerLabelProps, nativeTriggerProps: {
