...
export declare function NativeListRoot({ backgroundColor, children, contextMenuProps, contentContainerStyle, contentMarginBottom, contentMarginTop, defaultSelectedIds, editMode, editModeIcon, editModeSelectedIcon, editModeSelectedSfSymbol, editModeSfSymbol, fixesIOS26NestedScrollIndicatorSafeArea: _fixesIOS26NestedScrollIndicatorSafeArea, initialScrollTarget, iosEditModeVariant: _iosEditModeVariant, native: _native, navigationBarScrollEdgeOptions, onRefresh, onSelectedIdsChange, scrollable, selectedIds, style, tracksNavigationBarScrollEdge, ...rest }: NativeListRootProps): import("react").JSX.Element;
