...
export declare function NativeListSection({ children, contextMenuProps, disabledStyle, footer, trailing, title, titleColor, titleFontSize, }: NativeListSectionProps): import("react").JSX.Element;
export declare function NativeListRoot({ backgroundColor, children, contextMenuProps, disabledStyle, contentContainerStyle, contentMarginBottom, contentMarginTop, defaultSelectedIds, dismissKeyboardOnTap: _dismissKeyboardOnTap, editMode, editModeIcon, editModeSelectedIcon, editModeSelectedSfSymbol, editModeSfSymbol, fixesIOS26NestedScrollIndicatorSafeArea: _fixesIOS26NestedScrollIndicatorSafeArea, initialScrollTarget, iosListStyle: _iosListStyle, native: _native, navigationBarScrollEdgeOptions, onRefresh, onSelectedIdsChange, refreshColor, refreshEnabledInEditMode, scrollable, selectedIds, style, tracksNavigationBarScrollEdge, ...rest }: NativeListRootProps): import("react").JSX.Element;
