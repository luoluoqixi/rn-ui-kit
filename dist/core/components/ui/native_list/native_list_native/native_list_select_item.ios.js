...
export function NativeListSelectItem({ selectProps, ...itemProps }) {
    ...
    return (_jsx(NativePressRow, { ...itemProps, disabled: disabled, labelOpacity: fadeTitleOnOpen && menuOpen ? NATIVE_LIST_ITEM_OPEN_OPACITY : 1, nativeHaptics: false, onPress: () => menuRef.current?.presentMenu(), trailingControl: _jsx(NativeHostedTrailingControl, { disableInEditMode: true, children: _jsx(Dropdown, { ...selectProps, __menuRef: menuRef, items: menuItems, native: true, nativeHaptics: inheritedHaptics, nativeTrigger: true, nativeTriggerContainerStyle: styles.selectInlineTrigger, nativeTriggerIcon: "chevrons-up-down", nativeTriggerLabelProps: {
