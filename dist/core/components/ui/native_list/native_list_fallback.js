...
function FallbackRowContainer({ backgroundColor, children, contextMenuProps, disabled, editingSelected, hoverBackgroundColor, nativeHaptics, onPress, paddingBottom, paddingHorizontal, paddingLeft, paddingRight, paddingTop, paddingVertical, pressResetToken, pressBackgroundColor, }) {
    ...
    const ios15EditPressScrollGenerationRef = useRef(null);
    ...
    const wrapIosNativeContextMenu = (row) => usesIosNativeContextMenuTrigger ? (_jsx(ContextMenu, { ...activeNativeContextMenuProps, trigger: row, triggerProps: {
    ...
    const row = (_jsx(Pressable, { disabled: disabled, onHoverIn: () => setHovered(true), onHoverOut: () => setHovered(false), onPressIn: usesIosSwitchPressFallback ? () => setPressed(true) : undefined, onLongPress: programmaticContextMenuProps != null
            ? () => contextMenuRef.current?.presentMenu()
            : undefined, onPress: onPress != null ? handleRowPress : undefined, onPressOut: usesIosSwitchPressFallback ? () => setPressed(false) : undefined, onTouchCancel: usesIos15EditPressRecovery ? clearIos15EditTouch : undefined, onTouchEnd: usesIos15EditPressRecovery ? handleTouchEnd : undefined, onTouchStart: usesIos15EditPressRecovery ? handleTouchStart : undefined, style: styles.pressable, children: ({ pressed: pressablePressed }) => (_jsx(View, { style: [
                styles.rowContainer,
                resolvedRowPadding,
...
function NativeListRow({ backgroundColor, chevron = false, chevronColor, contextMenuProps, disabled, hoverBackgroundColor, icon, iconAfter, iconSlotWidth, nativeHaptics, nativeScrollId, onPress, paddingBottom, paddingHorizontal, paddingLeft, paddingRight, paddingTop, paddingVertical, pressResetToken, pressBackgroundColor, selectionId, selected = false, subtitle, subtitleColor, subtitleFontSize, trailing, title, titleAlign, titleColor, titleFontSize, value, valueColor, valueFontSize, valueOpacity, }) {
...
function appendSectionEntries(entries, sectionProps, sectionKey, inheritedContextMenuProps) {
    ...
    const hasSectionContent = title != null ||
        trailing != null ||
...
export function NativeListSelectItem({ selectProps, ...itemProps }) {
    ...
    if (editMode) {
        return (_jsx(NativeListRow, { ...itemProps, disabled: disabled, value: selectedLabel, valueColor: itemProps.valueColor ?? "$color10", valueOpacity: 0.5 }));
    }
