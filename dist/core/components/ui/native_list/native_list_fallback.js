...
function NativeListRow({ backgroundColor, chevron = false, chevronColor, contextMenuProps, disabled, hoverBackgroundColor, icon, iconAfter, iconSlotWidth, labelOpacity = 1, nativeHaptics, nativeScrollId, onPress, paddingBottom, paddingHorizontal, paddingLeft, paddingRight, paddingTop, paddingVertical, pressResetToken, pressBackgroundColor, selectionId, selectionDisabled, selected = false, subtitle, subtitleColor, subtitleFontSize, trailing, title, titleAlign, titleColor, titleFontSize, value, valueColor, valueFontSize, valueOpacity, }) {
...
export function NativeListMenuItem({ menuProps, ...itemProps }) {
    ...
    if (os() === "ios") {
        return (_jsx(NativeListRow, { ...itemProps, disabled: disabled, labelOpacity: fadeTitleOnOpen && menuOpen ? 0.6 : 1, nativeHaptics: false, onPress: () => {
                ...
                menu.presentMenu();
            }, iconAfter: _jsx(View, { collapsable: false, onTouchCancel: inlineTriggerGuard.cancelTriggerInteraction, onTouchEnd: inlineTriggerGuard.finishTriggerInteraction, onTouchStart: inlineTriggerGuard.beginTriggerInteraction, children: _jsx(Menu, { ...menuProps, nativeHaptics: menuProps.nativeHaptics ?? itemProps.nativeHaptics ?? false, nativeTrigger: true, nativeTriggerContainerStyle: [
                        styles.selectInlineTrigger,
                        disabled ? styles.disabledContent : null,
                    ], nativeTriggerIcon: "chevrons-up-down", nativeTriggerLabel: itemProps.value ?? "更多", nativeTriggerLabelProps: {
                        color: itemProps.valueColor ?? "$color10",
                        fontSize: itemProps.valueFontSize ?? "$4",
                        numberOfLines: 1,
                        opacity: 1,
