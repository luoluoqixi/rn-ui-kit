...
function FallbackRowContainer({ backgroundColor, children, disabled, hoverBackgroundColor, nativeHaptics, onPress, paddingBottom, paddingHorizontal, paddingLeft, paddingRight, paddingTop, paddingVertical, pressBackgroundColor, }) {
...
function NativeListRow({ backgroundColor, chevron = false, disabled, hoverBackgroundColor, icon, iconAfter, iconSlotWidth, nativeHaptics, onPress, paddingBottom, paddingHorizontal, paddingLeft, paddingRight, paddingTop, paddingVertical, pressBackgroundColor, selected = false, subtitle, subtitleColor, subtitleFontSize, title, titleAlign, titleColor, titleFontSize, value, valueColor, valueFontSize, }) {
