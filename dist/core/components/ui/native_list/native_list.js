...
export function NativeListRoot({ native, ...props }) {
    const useNative = useResolvedNativeMode(native);
    const Component = useNative ? Native.NativeListRoot : Basic.NativeListRoot;
    return (_jsx(NativeListModeContext.Provider, { value: useNative, children: _jsx(Component, { ...props }) }));
}
export const NativeList = NativeListRoot;
export function NativeListSection({ native, ...props }) {
    const useNative = useResolvedNativeMode(native);
