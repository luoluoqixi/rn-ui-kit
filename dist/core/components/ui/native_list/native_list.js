...
import { NativeListDisabledProvider, useResolvedNativeListDisabled, } from "./disabled";
...
export function NativeListRoot({ disabled, native, nativeTriggerFontWeight, ...props }) {
    const useNative = useResolvedNativeMode(native);
    const Component = useNative ? Native.NativeListRoot : Basic.NativeListRoot;
    return (_jsx(NativeListDisabledProvider, { disabled: disabled, children: _jsx(NativeListModeContext.Provider, { value: useNative, children: _jsx(NativeListTriggerFontWeightProvider, { nativeTriggerFontWeight: nativeTriggerFontWeight, children: _jsx(Component, { ...props }) }) }) }));
}
export const NativeList = NativeListRoot;
export function NativeListSection({ disabled, native, nativeTriggerFontWeight, ...props }) {
    const useNative = useResolvedNativeMode(native);
    const Component = useNative
        ? Native.NativeListSection
        : Basic.NativeListSection;
    return (_jsx(NativeListDisabledProvider, { disabled: disabled, children: _jsx(NativeListTriggerFontWeightProvider, { nativeTriggerFontWeight: nativeTriggerFontWeight, children: _jsx(Component, { ...props }) }) }));
}
function dispatchItem(native, NativeItem, BasicItem, props) {
    ...
    return _jsx(Component, { ...props, disabled: disabled });
}
