...
export function NativeListRoot({ basicScrollViewProps, children, contextMenuProps, contentContainerStyle, contentMarginBottom, contentMarginTop, defaultSelectedIds, disabledStyle, nativeHaptics, editMode, editModeIcon, editModeSelectedIcon, editModeSelectedSfSymbol, editModeSfSymbol, iosListStyle: _iosListStyle, iosPressFeedback: _iosPressFeedback, listStyle = NATIVE_LIST_BASIC_DEFAULT_STYLE, listStyleOptions, onRefresh, onSelectedIdsChange, refreshColor, refreshEnabledInEditMode: _refreshEnabledInEditMode, scrollable = true, selectedIds, style, ...scrollViewProps }) {
    ...
    const { contentContainerStyle: basicContentContainerStyle, refreshControl: basicRefreshControl, style: basicScrollViewStyle, ...basicScrollViewRestProps } = basicScrollViewProps ?? {};
    ...
    return (_jsx(ScrollView, { ...scrollViewProps, ...basicScrollViewRestProps, contentContainerStyle: [
            styles.content,
            contentContainerStyle,
            basicContentContainerStyle,
            contentMarginTop != null && { paddingTop: contentMarginTop },
            contentMarginBottom != null && { paddingBottom: contentMarginBottom },
        ], refreshControl: onRefresh == null ? basicRefreshControl : (_jsx(RefreshControl, { colors: [refreshColor ?? theme.primary], enabled: !editMode, onRefresh: () => {
                setRefreshing(true);
                Promise.resolve(onRefresh()).finally(() => setRefreshing(false));
            }, progressBackgroundColor: backgrounds.screen, refreshing: refreshing, tintColor: refreshColor ?? theme.primary })), style: [styles.root, { backgroundColor: backgrounds.screen }, style, basicScrollViewStyle], children: content }));
}
