import type { NativeListActionItemProps, NativeListButtonItemProps, NativeListCustomItemProps, NativeListInputItemProps, NativeListItemProps, NativeListDropdownItemProps, NativeListNavigationItemProps, NativeListRootProps, NativeListSectionProps, NativeListSelectItemProps, NativeListSwitchItemProps, NativeListTextAreaItemProps } from "./types";
/** iOS keeps the historical SwiftUI list as its default; other platforms use basic rows. */
export declare function NativeListRoot({ native, nativeTriggerFontWeight, ...props }: NativeListRootProps): import("react").JSX.Element;
export declare const NativeList: typeof NativeListRoot;
export declare function NativeListSection({ native, nativeTriggerFontWeight, ...props }: NativeListSectionProps & {
    native?: boolean;
