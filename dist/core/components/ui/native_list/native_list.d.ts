...
export declare function NativeListRoot({ native, ...props }: NativeListRootProps): import("react").JSX.Element;
export declare const NativeList: typeof NativeListRoot;
export declare function NativeListSection({ native, ...props }: NativeListSectionProps & {
    native?: boolean;
