...
export declare function NativeListRoot({ basicScrollViewProps, children, contextMenuProps, contentContainerStyle, contentMarginBottom, contentMarginTop, defaultSelectedIds, disabledStyle, nativeHaptics, editMode, editModeIcon, editModeSelectedIcon, editModeSelectedSfSymbol, editModeSfSymbol, iosListStyle: _iosListStyle, iosPressFeedback: _iosPressFeedback, listStyle, listStyleOptions, onRefresh, onSelectedIdsChange, refreshColor, refreshEnabledInEditMode: _refreshEnabledInEditMode, scrollable, selectedIds, style, ...scrollViewProps }: NativeListRootProps): React.JSX.Element;
