...
// @ts-ignore
ios15ListRowSeparatorHidden, layoutPriority, lineLimit, listRowBackground, listRowInsets, listSectionSpacing, listStyle, multilineTextAlignment, opacity, padding, scrollContentBackground, scrollDisabled, shapes, tag, tint, toggleStyle, viewID, } from "@expo/ui/swift-ui/modifiers";
...
const NativeListContext = createContext({
    native: true,
});
...
function NativeRowContainer({ children, contextMenuProps, disabled, disabledStyle, nativeSelectionId, nativeScrollId, onPress, paddingBottom, paddingHorizontal, paddingLeft, paddingRight, paddingTop, paddingVertical, btnStyle, btnTint, rowAlignment = "center", rowMinHeight, }) {
    const theme = useTheme();
...
function NativeHostedCustomRow({ children, disabled = false, disableInteractions = false, }) {
...
function NativeListRoot({ automaticallyAdjustsScrollIndicatorInsets, backgroundColor, children, contextMenuProps, disabledStyle, contentInsetAdjustmentBehavior, contentMarginBottom, contentMarginTop, defaultSelectedIds, dismissKeyboardOnTap = false, editMode, editModeIcon, editModeSelectedIcon, editModeSelectedSfSymbol, editModeSfSymbol, fixesIOS26NestedScrollIndicatorSafeArea, initialScrollTarget, iosListStyle = "insetGrouped", native = true, nestedScrollEnabled, navigationBarScrollEdgeOptions, onRefresh, onSelectedIdsChange, refreshColor: _refreshColor, refreshEnabledInEditMode = false, scrollIndicatorInsets, style, scrollable = true, selectedIds, tracksNavigationBarScrollEdge, webAutoRestoreScroll: _webAutoRestoreScroll, ...fallbackProps }) {
    ...
    return (_jsx(NativeListEditModeProvider, { defaultSelectedIds: defaultSelectedIds, editMode: editMode, nativeSelectionEnabled: true, onSelectedIdsChange: handleSelectedIdsChange, selectedIds: resolvedSelectedIds, children: _jsx(NativeListContext.Provider, { value: { native: true }, children: _jsx(Host, { style: [styles.nativeRoot, style], children: _jsx(List
                ...
                , { 
                    ...
                    ], children: _jsx(NativeListContextMenuProvider, { contextMenuProps: contextMenuProps, disabledStyle: disabledStyle, children: children }) }) }) }) }));
}
function NativeListSection({ children, contextMenuProps, disabledStyle, footer, trailing, title, titleColor, titleFontSize, }) {
    ...
    if (!nativeListEnabled) {
        return (_jsx(FallbackSection, { contextMenuProps: contextMenuProps, disabledStyle: resolvedDisabledStyle, footer: resolvedFooter, trailing: resolvedTrailing, title: resolvedTitle, titleColor: titleColor, titleFontSize: titleFontSize, children: children }));
    }
    const stringTitle = toPlainText(resolvedTitle);
    const sectionChildren = Children.map(children, (child) => child != null ? (_jsx(NativeListContextMenuProvider, { contextMenuProps: resolvedContextMenuProps, disabledStyle: resolvedDisabledStyle, children: child })) : null);
...
function NativeIos15MenuSelectRow({ itemProps, selectItems, selectProps, }) {
    ...
    const selectedSwatchColor = selectedItem?.swatchColor == null
        ? undefined
    ...
    const renderSelectOption = (item) => {
        ...
        if (item.swatchColor == null) {
            return (_jsx(SwiftButton, { label: item.label, modifiers: [disabledModifier(optionDisabled)], onPress: () => handleSelection(item.value), systemImage: isSelected ? "checkmark" : undefined }, optionKey));
        }
        const swatchColor = toSwiftUIHexColor(item.swatchColor) ?? item.swatchColor;
        return (_jsx(SwiftButton, { modifiers: [disabledModifier(optionDisabled)], onPress: () => handleSelection(item.value), children: _jsxs(HStack, { modifiers: [frame({ maxWidth: 99999, alignment: "leading" })], spacing: 8, children: [isSelected ? _jsx(Image, { size: 14, systemName: "checkmark" }) : null, _jsx(SwiftText, { children: item.label }), _jsx(Spacer, { minLength: 24 }), _jsx(Image, { color: swatchColor, size: 14, systemName: "circle.fill" })] }) }, optionKey));
    };
    if (!fadeTitleOnOpen) {
        ...
        return (_jsx(NativeRowContainer, { contextMenuProps: disabled || editRow.editMode || resolvedContextMenuProps?.triggerProps?.disabled
                ? undefined
                : resolvedContextMenuProps, disabled: disabled, disabledStyle: itemProps.disabledStyle, nativeScrollId: itemProps.nativeScrollId, nativeSelectionId: editRow.nativeSelection ? editRow.selectionId : undefined, paddingBottom: itemProps.paddingBottom, paddingHorizontal: itemProps.paddingHorizontal, paddingLeft: itemProps.paddingLeft, paddingRight: itemProps.paddingRight, paddingTop: itemProps.paddingTop, paddingVertical: itemProps.paddingVertical, children: _jsxs(ZStack, { alignment: "center", modifiers: [frame({ maxWidth: 99999, alignment: "leading" })], children: [_jsxs(HStack, { modifiers: [frame({ maxWidth: 99999, alignment: "leading" })], spacing: 12, children: [leadingContent, _jsx(Spacer, { minLength: 12 })] }), _jsx(SwiftMenu, { label: _jsxs(HStack, { modifiers: [
                                frame({ maxWidth: 99999, alignment: "leading" }),
                                contentShape(shapes.rectangle()),
                            ], spacing: 12, children: [_jsx(HStack, { modifiers: [opacity(0)], spacing: 12, children: leadingContent }), _jsx(Spacer, { minLength: 12 }), _jsxs(HStack, { modifiers: [opacity(editMode ? 0.5 : 1)], spacing: 4, children: [selectedSwatchColor != null ? (_jsx(Image, { color: selectedSwatchColor, size: 14, systemName: "circle.fill" })) : null, _jsx(SwiftText, { modifiers: [
                            ...
                            contentShape(shapes.rectangle()),
                            disabledModifier(editMode || disabled),
                        ], children: selectItems.map(renderSelectOption) })] }) }));
    }
    return (_jsx(NativeRowContainer, { contextMenuProps: disabled || editRow.editMode || resolvedContextMenuProps?.triggerProps?.disabled
            ? undefined
...
export function NativeListSelectItem({ selectProps, ...itemProps }) {
    ...
    const usesIos15NativeMenu = isIos15() &&
        ...
        !selectItems.some((item) => item.description != null || item.startContent != null || item.endContent != null) &&
    ...
    return (_jsx(NativePressRow, { ...itemProps, disabled: disabled, labelOpacity: resolvedPickerMode === "dropdown" && fadeTitleOnOpen && dropdownOpen ? 0.6 : 1, nativeHaptics: resolvedHaptics, onPress: () => {
            ...
            picker.open();
                ...
                ], nativeTriggerContent: selectProps.nativeTriggerContent, nativeTriggerIcon: selectProps.nativeTriggerIcon ?? "chevrons-up-down", nativeTriggerLabel: nativeTriggerLabel, nativeTriggerLabelProps: nativeTriggerLabelProps, 
...
export function NativeListMenuItem({ menuProps, ...itemProps }) {
    ...
    return (_jsx(NativePressRow, { ...itemProps, disabled: disabled, labelOpacity: fadeTitleOnOpen && menuOpen ? 0.6 : 1, nativeHaptics: false, onPress: () => {
            ...
            menu.presentMenu();
        }, trailingControl: _jsx(NativeHostedTrailingControl, { disableInEditMode: true, children: _jsx(Menu, { ...menuProps, nativeHaptics: menuProps.nativeHaptics ?? itemProps.nativeHaptics ?? false, nativeTrigger: true, nativeTriggerContainerStyle: [styles.selectInlineTrigger], nativeTriggerIcon: "chevrons-up-down", nativeTriggerLabel: menuValue, nativeTriggerLabelProps: {
                    color: itemProps.valueColor ?? "$color10",
                    fontSize: itemProps.valueFontSize ?? "$4",
                    numberOfLines: 1,
                    opacity: 1,
...
export function NativeListCustomItem({ backgroundColor, children, contextMenuProps, disabled, disabledStyle, hoverBackgroundColor, nativeHaptics, nativeScrollId, onPress, paddingBottom, paddingHorizontal, paddingLeft, paddingRight, paddingTop, paddingVertical, pressBackgroundColor, selectionId, selectionDisabled, }) {
    ...
    const swiftUIContextMenuProps = hasSwiftUIContextMenu(activeContextMenuProps)
        ...
        : undefined;
    if (!useNativeListEnabled()) {
        return (_jsx(FallbackCustomItem, { backgroundColor: backgroundColor, contextMenuProps: contextMenuProps, disabled: disabled, disabledStyle: resolvedDisabledStyle, hoverBackgroundColor: hoverBackgroundColor, nativeHaptics: nativeHaptics, nativeScrollId: nativeScrollId, onPress: onPress, ...rowPaddingProps, pressBackgroundColor: pressBackgroundColor, selectionId: selectionId, selectionDisabled: selectionDisabled, children: children }));
    }
    if (editRow.editMode) {
    ...
    if (onPress == null) {
        ...
        const customRow = (_jsx(VStack, { modifiers: rowModifiers, children: _jsx(NativeHostedCustomRow, { disabled: Boolean(disabled && resolvedDisabledStyle), disableInteractions: Boolean(disabled), children: children }) }));
        if (swiftUIContextMenuProps != null) {
    ...
    if (restoresIos15TopCorners) {
        const button = (_jsx(SwiftButton, { modifiers: [disabledModifier(disabled ?? false)], onPress: () => {
                ...
                ], children: _jsx(NativeHostedCustomRow, { disabled: Boolean(disabled && resolvedDisabledStyle), disableInteractions: Boolean(disabled), children: children }) }) }));
        return swiftUIContextMenuProps != null ? (_jsx(NativeSwiftUIContextMenu, { contextMenuProps: swiftUIContextMenuProps, children: button })) : (button);
    }
    const button = (_jsx(SwiftButton, { modifiers: [
            disabledModifier(disabled ?? false),
