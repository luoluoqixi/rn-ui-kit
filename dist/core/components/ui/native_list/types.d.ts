...
export type NativeListIosStyle = "automatic" | "plain" | "inset" | "insetGrouped" | "grouped" | "sidebar";
...
export type NativeListColorPickerItemProps = NativeListItemBaseProps & {
    ...
    sheetProps?: Omit<NativeSheetProps, "children" | "content" | "open" | "onOpenChange" | "detents" | "snapPoints">;
...
export type NativeListDropdownItemProps = NativeListItemBaseProps & {
    ...
    fadeTitleOnOpen?: boolean;
    dropdownProps: Omit<DropdownProps, "nativeTrigger" | "nativeTriggerContainerStyle" | "nativeTriggerContent" | "nativeTriggerIcon" | "nativeTriggerLabelProps" | "trigger">;
};
