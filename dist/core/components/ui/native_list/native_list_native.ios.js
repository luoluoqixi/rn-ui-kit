...
export function renderNativeListSelectTriggerLabel(label, swatchColor, labelProps) {
    const { color: configuredColor, opacity: configuredOpacity, style: configuredStyle, ...textProps } = (labelProps ?? {});
