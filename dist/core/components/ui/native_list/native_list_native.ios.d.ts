...
export declare function NativeSwiftUIContextMenu({ children, contextMenuProps, }: {
...
export declare function NativeRowContainer({ children, contextMenuProps, disabled, disabledStyle, nativeSelectionId, nativeScrollId, onPress, paddingBottom, paddingHorizontal, paddingLeft, paddingRight, paddingTop, paddingVertical, btnStyle, btnTint, rowAlignment, rowMinHeight, }: {
    children: ReactNode;
    contextMenuProps?: NativeListContextMenuProps;
    disabled?: boolean;
