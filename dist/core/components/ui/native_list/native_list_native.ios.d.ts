...
type SwiftUIButtonStyle = "automatic" | "bordered" | "borderedProminent" | "borderless" | "glass" | "glassProminent" | "noPressEffect" | "plain";
...
export declare function NativeRowContainer({ children, contextMenuProps, contextMenuDisabled, disabled, disabledStyle, ios15FirstRowTopInset, nativeSelectionActive, nativeSelectionId, nativeNavigationSelectionId, nativeScrollId, onPress, paddingBottom, paddingHorizontal, paddingLeft, paddingRight, paddingTop, paddingVertical, btnStyle, btnTint, rowAlignment, rowMinHeight, }: {
    children: ReactNode;
    contextMenuProps?: NativeListContextMenuProps;
