...
export const NATIVE_LIST_BASIC_DEFAULT_STYLE = "rounded";
...
export const NATIVE_LIST_TRAILING_TRIGGER_COLOR_TOKEN = "primary";
/** NativeList 右侧 Select/Dropdown trigger 的统一常规字重。 */
export const NATIVE_LIST_TRAILING_TRIGGER_FONT_WEIGHT = "400";
...
export const NATIVE_LIST_BASIC_SECTION_TEXT_COLOR_TOKEN = "mutedForeground";
