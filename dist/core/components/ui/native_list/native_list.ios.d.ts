...
declare function NativeListRoot({ automaticallyAdjustsScrollIndicatorInsets, backgroundColor, children, contextMenuProps, contentInsetAdjustmentBehavior, contentMarginBottom, contentMarginTop, defaultSelectedIds, editMode, editModeIcon, editModeSelectedIcon, editModeSelectedSfSymbol, editModeSfSymbol, fixesIOS26NestedScrollIndicatorSafeArea, initialScrollTarget, iosEditModeVariant, native, nestedScrollEnabled, navigationBarScrollEdgeOptions, onRefresh, onSelectedIdsChange, scrollIndicatorInsets, style, scrollable, selectedIds, tracksNavigationBarScrollEdge, webAutoRestoreScroll: _webAutoRestoreScroll, ...fallbackProps }: NativeListRootProps): import("react").JSX.Element;
declare function NativeListSection({ children, contextMenuProps, footer, trailing, title, titleColor, titleFontSize, }: NativeListSectionProps): import("react").JSX.Element;
 ...
 */
export declare function NativeListInputItem({ inputProps, ...itemProps }: NativeListInputItemProps): import("react").JSX.Element;
