...
export const GlassEffectSearchBar = forwardRef(function GlassEffectSearchBar({ cancelButtonAccessibilityLabel = "取消搜索", cancelButtonContainerStyle, cancelButtonProps, cancelButtonStyle, clearOnCancel = true, dismissKeyboardOnCancel = true, focused: focusedProp, inputColor, inputProps, inputStyle, keyboardAvoidance = true, keyboardHiddenConfirmation, onCancel, onFocusChange, placeholder = "搜索", placeholderTextColor, searchIcon, searchIconColor, searchStyle, style, focusedTrailing, unfocusedTrailing, ...glassProps }, forwardedRef) {
    ...
    const defaultFocusedTrailing = (_jsx(View, { style: [styles.cancelButtonContainer, cancelButtonContainerStyle], children: _jsx(Button, { circular: !usesNativeCancelButton, ...cancelButtonProps, "aria-label": cancelButtonAccessibilityLabel, native: usesNativeCancelButton, nativeButtonStyle: usesNativeCancelButton ? (cancelButtonStyle ?? "glass") : undefined, nativeSystemImage: usesNativeCancelButton ? "xmark" : undefined, nativeSystemImageSize: cancelButtonProps?.nativeSystemImageSize ?? 22, variant: "secondary", buttonSize: cancelButtonProps?.buttonSize ?? {
                height: usesNativeCancelButton ? 40 : 50,
                width: usesNativeCancelButton ? 40 : 50,
            }, onPress: handleCancel, style: cancelButtonProps?.style, title: usesNativeCancelButton ? (cancelButtonProps?.title ?? "×") : undefined, children: usesNativeCancelButton ? undefined : _jsx(X, { size: 24 }) }) }));
