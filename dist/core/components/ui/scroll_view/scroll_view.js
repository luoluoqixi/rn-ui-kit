...
const WebTrackedScrollView = forwardRef((props, ref) => {
    const { bottomSheetScrollable: _bottomSheetScrollable, navigationBarScrollEdgeOptions, onScroll, scrollEventThrottle, tracksNavigationBarScrollEdge, ...webProps } = props;
    ...
    return (_jsx(TamaguiScrollView, { ref: ref, onScroll: trackedOnScroll, scrollEventThrottle: scrollEventThrottle ?? (trackedOnScroll == null ? undefined : 16), ...webProps }));
});
