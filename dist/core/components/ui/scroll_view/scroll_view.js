...
export const ScrollView = forwardRef((props, ref) => {
    ...
    const { automaticallyAdjustsScrollIndicatorInsets, iosEmptyViewportScrollEnabled = true, navigationBarScrollEdgeOptions, nestedScrollEnabled, scrollIndicatorInsets, tracksNavigationBarScrollEdge = false, ...restProps } = props;
