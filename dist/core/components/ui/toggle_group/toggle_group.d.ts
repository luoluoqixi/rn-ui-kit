...
declare function ToggleGroupItem({ className, children, variant, size, isFirst, isLast, nativeHaptics, title, onPress, onPressIn, onPressOut, ...props }: React.ComponentProps<typeof ToggleGroupPrimitive.Item> & VariantProps<typeof toggleVariants> & {
    isFirst?: boolean;
    isLast?: boolean;
