...
export function BasicToaster({ accentThemeName: _accentThemeName, viewportName, offset, defaultNative: _defaultNative, iconSize = "default", basicHaptics, haptics, customToastViewProps, sonnerNativeProps, sonnerProps: _sonnerProps, closeButton, closeButtonIcon: _closeButtonIcon, closeButtonClassName: _closeButtonClassName, ...props }) {
