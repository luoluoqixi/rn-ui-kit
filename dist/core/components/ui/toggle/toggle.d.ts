...
declare function Toggle({ className, variant, size, nativeHaptics, title, children, onPressedChange, onPressIn, onPressOut, onHoverIn, onHoverOut, ...props }: ToggleProps): React.JSX.Element;
