...
export type ScreenOverlayPortalOffset = {
    x: number;
    y: number;
};
...
export declare function ScreenOverlayPortalHost({ hostName, onPortalOffsetChange, onTeleportHostNode, }: {
    hostName: string;
...
export declare function useScreenOverlayPortalOffset(): ScreenOverlayPortalOffset | null;
