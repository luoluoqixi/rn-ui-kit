...
function RadioGroupItem({ className, description, descriptionClassName, indicatorClassName, indicatorProps, label, labelClassName, labelPosition = "right", nativeHaptics, containerClassName, onPress, onPressIn, onPressOut, onHoverIn, onHoverOut, value, size, disabled, ...props }) {
    ...
    const resolvedItemStyle = typeof props.style === "function"
