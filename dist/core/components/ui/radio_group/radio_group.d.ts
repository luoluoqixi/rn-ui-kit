...
declare function RadioGroupItem({ className, description, descriptionClassName, indicatorClassName, indicatorProps, label, labelClassName, labelPosition, nativeHaptics, containerClassName, onPress, onPressIn, onPressOut, value, size, disabled, ...props }: RadioGroupItemProps): React.JSX.Element;
