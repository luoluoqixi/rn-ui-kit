...
const Button = React.forwardRef(function Button({ buttonSize, children, circular, className, native, nativeButtonStyle = "automatic", nativeComposeProps, nativeHaptics, nativeSwiftProps, nativeSystemImage, nativeSystemImageSize, loading = false, loadingIcon, onPress, size = "default", style, title, variant, ...props }, ref) {
