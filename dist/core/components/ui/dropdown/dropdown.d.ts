...
import { type NativeHapticsDelay, type NativeHapticsSetting } from "../utils";
...
declare function DropdownSubTrigger({ className, inset, children, iconClassName, nativeHaptics, nativeHapticsDelay, onPress, ...props }: React.ComponentProps<typeof DropdownPrimitive.SubTrigger> & {
...
declare function DropdownContent({ align, className, children, side: sideProp, itemNativeHaptics, itemNativeHapticsDelay, overlayClassName, overlayStyle, portalHost, size: sizeProp, style, ...props }: DropdownContentProps & {
...
declare function DropdownItem({ className, disabled, inset, nativeHaptics, nativeHapticsDelay, onPress, variant, ...props }: React.ComponentProps<typeof DropdownPrimitive.Item> & {
    className?: string;
    inset?: boolean;
    nativeHaptics?: NativeHapticsSetting;
    nativeHapticsDelay?: NativeHapticsDelay;
