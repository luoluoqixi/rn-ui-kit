...
declare function DropdownSubContent({ className, ...props }: React.ComponentProps<typeof DropdownPrimitive.SubContent>): React.JSX.Element;
declare function DropdownContent({ align, className, children, side: sideProp, itemNativeHaptics, overlayClassName, overlayStyle, portalHost, style, ...props }: React.ComponentProps<typeof DropdownPrimitive.Content> & {
