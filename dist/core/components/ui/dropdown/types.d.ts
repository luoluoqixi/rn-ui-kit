...
import type { NativeTriggerFaceProps, NativeTriggerFeedbackOpacity, NativeTriggerIcon, NativeTriggerProps } from "../native_trigger";
...
export type DropdownContentProps = Omit<ComponentProps<typeof DropdownPrimitive.Content>, "children"> & {
...
export type DropdownSubContentProps = Omit<ComponentProps<typeof DropdownPrimitive.SubContent>, "children"> & {
    children?: ReactNode;
    size?: DropdownSize;
};
/** Props applied to the generated Zeego menu content on native platforms. */
export type NativeDropdownContentProps = Omit<ComponentProps<typeof Zeego.Content>, "children"> & Record<string, unknown>;
