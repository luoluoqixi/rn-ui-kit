...
function DropdownContent({ align = "center", className, children, side: sideProp, itemNativeHaptics, overlayClassName, overlayStyle, portalHost, size: sizeProp, style, ...props }) {
...
function Dropdown({ children, contentProps, contentSize, __nativeDetachedAnchor, __menuRef, defaultOpen, disabled, items, itemProps, itemNativeHaptics, native = Platform.OS !== "web", nativeAnchorAlignment, nativeHaptics, nativeSelectedItemBackgroundColor, nativeTrigger, nativeTriggerContainerStyle, nativeTriggerContent, nativeTriggerIcon, nativeTriggerLabelProps, nativeTriggerProps, nativeTriggerFeedbackOpacity, nativeTriggerHoverBackground, nativeContentProps, open, onOpenChange, onOpenWillChange, trigger, triggerClassName, triggerLabel, triggerProps, ...props }) {
    ...
    return (_jsx(DropdownHapticsContext.Provider, { value: { item: resolvedItemHaptics }, children: _jsx(DropdownContentSizeContext.Provider, { value: contentSize ?? "default", children: _jsx(DropdownPrimitiveRoot, { ...props, ...(defaultOpen === undefined ? {} : { defaultOpen }), ...(open === undefined ? {} : { open }), onOpenChange: (open) => {
