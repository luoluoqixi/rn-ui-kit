...
function MenuRoot(props) {
    const { arrow, arrowProps, children, contentProps, itemProps, items, nativeHaptics, offset, onOpenChange, onOpenWillChange, portalProps, trigger, triggerProps, ...rootProps } = props;
    ...
    if (!hasDefaultStructure) {
        return (_jsx(TamaguiMenu, { ...rootProps, ...iosOpenWillChangeProps, offset: offset ?? 8, onOpenChange: handleOpenChange, children: resolvedChildren }));
    }
    return (_jsxs(TamaguiMenu, { ...rootProps, ...iosOpenWillChangeProps, offset: offset ?? 8, onOpenChange: handleOpenChange, children: [trigger != null ? _jsx(MenuTrigger, { ...triggerProps, children: trigger }) : null, _jsx(MenuPortal, { ...portalProps, children: _jsxs(MenuContent, { ...contentProps, children: [arrow ? _jsx(MenuArrow, { ...arrowProps }) : null, _jsxs(MenuScrollView, { children: [resolvedItems?.map((item) => {
                                    if (item.separator) {
