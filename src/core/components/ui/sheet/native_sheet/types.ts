...
type NativeSheetEventProps = Pick<
  TrueSheetProps,
  | "onBackPress"
  | "onDidDismiss"
  | "onDidPresent"
...
type NativeSheetDirectProps = Omit<
  TrueSheetProps,
  | "backgroundColor"
  | "children"
  | "detents"
...
export type NativeSheetProps = NativeSheetDirectProps &
  NativeSheetEventProps & {
